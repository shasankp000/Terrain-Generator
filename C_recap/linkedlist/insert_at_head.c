...
int main() {
  ...
  printf("Enter element to be inserted at the head of the list: ");
  scanf("%d", element);
  printf("\n");
  

  // no need to check if head is not null, since if memory allocation fails earlier then program will exit.
